...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Agregar Producto</h3>
        </div>
                    ...
                    <div class="card-body">
                        <div class="input-states">
                            <form class="row" method="POST" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="ontrol-label">Nombre Producto</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label">Porducto Recetado por Medico - nivel - (PRM) </label>
