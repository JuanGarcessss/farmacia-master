...
<footer class="bg-#52a501 text-white text-center text-lg-start fixed-bottom" >
  <!-- Grid container -->

  <!-- Grid container -->

  <!-- Copyright -->
  <div class="text-center p-3" style="background-color: #52a501">
      Universidadd cooperativa de colombia
    <a class="text-white" href="">Ucc</a>
  </div>
  <!-- Copyright -->
</footer>
</div>
